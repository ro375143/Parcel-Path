...
const UserProfile = (props) => {
                  ...
                  const userDatafromDB = async () => {
                                    ...
                                    console.log("documentSnapshot is : " + JSON.stringify(documentSnapshot._document.data.value.mapValue.fields))
                                    setUserInfo({
                                                      firstName: documentSnapshot._document.data.value.mapValue.fields.firstName.stringValue,
                                                      lastName: documentSnapshot._document.data.value.mapValue.fields.lastName.stringValue,
                                                      address: documentSnapshot._document.data.value.mapValue.fields.email.stringValue,
                                    })
                  ...
                  const loadDefaultUser = async () => {
                                    signInWithEmailAndPasswordFirebase(defaultUser.userName, defaultUser.password)
                                    console.log("CURRENT USER FROM DEFAULT is: " + JSON.stringify(auth.currentUser))
                  }
                  ...
                  return <div>
                                    <div style={{ fontWeight: "bold", color: "blue", fontSize: 25, flex: true, margin: 15 }}>PROFILE PAGE</div>
                                    <Form
                                                      form={form}
                                                      layout="vertical"
                                                      initialValues={{
                                    ...
                                    >
                                                      ...
                                                      {inputEnabled ? (
                                                                        ...
                                                                        (
                                                                                          <>
                                                                                                            <Button onClick={submitUser} disabled={inputEnabled}>Submit</Button>
                                                                                                            <Button onClick={cancelEditMode} disabled={inputEnabled}>Cancel</Button>
                                                                                          </>
                                                                        )
                                                      }
                                    </Form>
